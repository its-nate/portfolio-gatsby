    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col s12">
          ...
          <p className="page-body">
            I'm formerly a Frontend Software Engineer for <a href="https://midspace.app/" target="_blank" rel="noreferrer" className="page-link">Midspace</a>, a Frontend Developer for <a href="https://overourmoon.com/" target="_blank" rel="noreferrer" className="page-link">AndAlways</a>, and do contract and subcontract work through my company,&nbsp; 
